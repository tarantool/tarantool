...
static Keyword aKeywordTable[] = {
  ...
  { "CURRENT_DATE",           "TK_CURRENT_DATE",true  },
  { "CURRENT_TIME",           "TK_CURRENT_TIME",true  },
  { "CURRENT_TIMESTAMP",      "TK_TIMESTAMP",   true  },
  { "DATE",                   "TK_DATE",        true  },
  { "TIME",                   "TK_TIME",        true  },
  { "TIMESTAMP",              "TK_TIMESTAMP",   true  },
  { "INTERVAL",               "TK_INTERVAL",    true  },
  { "DATETIME",               "TK_TIMESTAMP",   true  },
  { "ZONE",                   "TK_ZONE",        true  },
  { "DEC",                    "TK_DECIMAL",     true  },
  ...
  { "LOCALTIME",              "TK_LOCALTIME",   true  },
  { "LOCALTIMESTAMP",         "TK_LOCALTIMESTAMP",true},
