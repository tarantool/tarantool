...
=======
C<tarantoolctl> - a utility to control Tarantool instances

=head1 SYNOPSIS

tarantoolctl COMMAND [NAME] [FILE] [URI] [OPTIONS...]

=head1 DESCRIPTION

C<tarantoolctl> may be used to introspect and control the state
of Tarantool instances.

The C<NAME> typically represents the name of an instance file.
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
...
=item eval NAME FILE
=item COMMAND | tarantoolctl eval NAME
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
...
=======
The file with system-wide defaults for C<tarantoolctl> is installed in
C</etc/default/tarantool>. This file is used when C<tarantoolctl> is invoked
by root. When invoked by a local user, C<tarantoolctl> first looks for its
defaults file in the current directory (C<$PWD/.tarantoolctl>), and then in
the current user's home directory (C<$HOME/.config/tarantool/tarantool>).
If not found, C<tarantoolctl> falls back to built-in defaults:
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
...
=======
Directory for the pid file and control-socket file; C<tarantoolctl> will add
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
...
=======
Directory for write-ahead *.xlog files; C<tarantoolctl> will add
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
"/instance_name" to the directory name.
...
=======
Directory for snapshot *.snap files; C<tarantoolctl> will add
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
"/instance_name" to the directory name.
...
=======
Directory for vinyl files; C<tarantoolctl> will add "/instance_name" to the
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
directory name.
...
=======
The place where the application log will go; C<tarantoolctl> will add
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
...
=======
Tarantool manual at L<http://tarantool.org/doc/>.
>>>>>>> a678f4c1afaef62fc828335fb5f478002e6fb9c7
