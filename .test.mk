...
# child process because its stderr pipe fills up. This option disables only
# the signal-safety check; data race detection remains enabled.
TEST_RUN_ENV_TSAN = TSAN_OPTIONS="suppressions=${PWD}/asan/tsan.supp report_signal_unsafe=0"
