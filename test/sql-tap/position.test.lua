...
test:do_execsql_test(
    "position-benchmark",
    [[
    CREATE TABLE t(i int primary key autoincrement, s STRING COLLATE "unicode_ci");
    insert into t(s) values('aaaaaaaaaa');
    UPDATE t SET s = s || s;
    UPDATE t SET s = s || s;
    UPDATE t SET s = s || s;
    UPDATE t SET s = s || s;
    ...
    UPDATE t SET s = s || s;
    UPDATE t SET s = s || s;
    UPDATE t SET s = s || s || 'b';

    SELECT POSITION('' COLLATE "unicode", s COLLATE "unicode") FROM t;
    ]],
    {2619841}
)
