...
test:do_catchsql_test("update-10.3", [[
  ...
  -- <update-10.3>
  1, "Duplicate key exists in unique index 'unique_unnamed_T1_1' in space 'T1': old tuple - '[1, 2, 3, 4, 9, 6, 1]', new tuple - '[1, 3, 4, 4, 10, 7, 2]'"
  -- </update-10.3>
})
...
test:do_catchsql_test("update-10.6", [[
  ...
  -- <update-10.6>
  1, "Duplicate key exists in unique index 'unique_unnamed_T1_2' in space 'T1': old tuple - '[1, 2, 3, 4, 11, 6, 1]', new tuple - '[2, 2, 4, 4, 12, 7, 2]'"
  -- </update-10.6>
})
...
test:do_catchsql_test("update-10.9", [[
  ...
  -- <update-10.9>
  1, "Duplicate key exists in unique index 'unique_unnamed_T1_3' in space 'T1': old tuple - '[1, 2, 3, 4, 13, 6, 1]', new tuple - '[2, 3, 3, 4, 14, 7, 2]'"
  -- </update-10.9>
})
