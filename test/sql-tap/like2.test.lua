...
test:do_test(
    ...
    function()
        return test:execsql [=[
            CREATE TABLE t1(x INT PRIMARY KEY, y COLLATE NOCASE);
...
test:do_test(
    ...
    function()
        return test:execsql [[
            CREATE TABLE t2(x INT PRIMARY KEY, y COLLATE NOCASE);
...
test:do_test(
    ...
    function()
        return test:execsql [[
            CREATE TABLE t3(x INT PRIMARY KEY, y COLLATE NOCASE);
