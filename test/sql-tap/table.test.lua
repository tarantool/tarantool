...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <table-21.2>
        1, "Duplicate key exists in unique index 'pk_unnamed_T21_1' in space 'T21': old tuple - '[1, 1, 1]', new tuple - '[1, 2, 2]'"
        -- </table-21.2>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <table-22.3>
        1,"Duplicate key exists in unique index 'ONE' in space 'T22': old tuple - '[1, 1, 1]', new tuple - '[2, 1, 1]'"
        -- </table-22.3>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <table-22.5>
        1, "Duplicate key exists in unique index 'TWO' in space 'T24': old tuple - '[1, 1, 1]', new tuple - '[2, 1, 1]'"
        -- </table-22.5>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <table-22.9>
        1, "Duplicate key exists in unique index 'pk_unnamed_T28_1' in space 'T28': old tuple - '[11]', new tuple - '[11]'"
        -- </table-22.9>
    })
