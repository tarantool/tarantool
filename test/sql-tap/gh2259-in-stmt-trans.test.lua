...
for _, prefix in pairs({"BEFORE", "AFTER"}) do
    ...
    test:do_catchsql_test(prefix..'_insert1',
                          ...
                          {1, "Duplicate key exists in unique index 'pk_unnamed_T2_2' in space 'T2': old tuple - '[1, 1]', new tuple - '[1, 1]'"})
    ...
    test:do_catchsql_test(prefix..'delete1',
                          'DELETE FROM t1;',
                          {1, "Duplicate key exists in unique index 'pk_unnamed_T2_2' in space 'T2': old tuple - '[2, 2]', new tuple - '[2, 2]'"})
