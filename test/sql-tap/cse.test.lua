...
test:do_test(
    ...
    function()
        ...
        -- <cse-1.1>
        11, -11, 18446744073709551604ULL, 0, 22, 121, 1, 11,
        21, -21, 18446744073709551594ULL, 0, 42, 441, 1, 21
        -- </cse-1.1>
    })
...
test:do_execsql_test(
    ...
    [[
        ...
        -- <cse-1.7>
        1, -1, 18446744073709551614ULL, 0, 2, 1, 1, 1,
        2, -2, 18446744073709551613ULL, 0, 4, 4, 1, 2
        -- </cse-1.7>
    })
