...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-1.3>
        1, "Duplicate key exists in unique index 'pk_unnamed_T1_1' in space 'T1': old tuple - '[1, 2, \"3\"]', new tuple - '[1, 3, \"4\"]'"
        -- </unique-1.3>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-1.5>
        1, "Duplicate key exists in unique index 'unique_unnamed_T1_2' in space 'T1': old tuple - '[1, 2, \"3\"]', new tuple - '[3, 2, \"4\"]'"
        -- </unique-1.5>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-2.3>
        1, "Duplicate key exists in unique index 'I2' in space 'T2': old tuple - '[1, 1, 2]', new tuple - '[3, 1, 5]'"
        -- </unique-2.3>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-2.8>
        1, "Duplicate key exists in unique index 'I2' in space 'T2': old tuple - '[1, 1, 2]', new tuple - '[4, 1, 5]'"
        -- </unique-2.8>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-3.4>
        1, "Duplicate key exists in unique index 'unique_unnamed_T3_2' in space 'T3': old tuple - '[2, 1, 2, 3, 5]', new tuple - '[3, 1, 4, 3, 5]'"
        -- </unique-3.4>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-4.10>
        1, "Duplicate key exists in unique index 'I4C' in space 'T4': old tuple - '[1, 1, 2, 3]', new tuple - '[2, null, 2, null]'"
        -- </unique-4.10>
    })
...
test:do_catchsql_test(
    ...
    [[
        ...
        -- <unique-5.2>
        1, "Duplicate key exists in unique index 'unique_unnamed_T5_2' in space 'T5': old tuple - '[1, 1, 2, 3, 4, 5, 6]', new tuple - '[2, 1, 2, 3, 4, 5, 6]'"
        -- </unique-5.2>
    })
