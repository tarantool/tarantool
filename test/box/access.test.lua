...
box.schema.user.grant('uniuser', 'read,write', 'space', '_space')
session.su('uniuser')
...
box.schema.user.grant('twostep', 'read,write', 'space', '_space')
...
box.schema.user.grant('tester', 'read', 'space', '_space')
