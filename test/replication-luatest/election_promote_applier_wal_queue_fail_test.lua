...
--
-- There was a bug that if PROMOTE request in applier was rolled back while
-- waiting in the journal's volatile queue, then it would try to be rolled back
-- second time and would crash in debug + have undefined behaviour in release.
--
