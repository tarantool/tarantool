...
g.before_all(function()
    ...
    g.box_cfg = {
        ...
        -- We use a huge election_timeout because otherwise the test may flaks.
        -- The problem is that sometimes some appliers can die during promotion
        -- and node doesn't have enough time to establish connection and send
        -- RequestVotes for them.
        election_timeout = 10
    }
