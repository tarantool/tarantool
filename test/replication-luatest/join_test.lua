...
--
-- gh-10089: raft state is never sent during META_JOIN stage.
-- If replica manages to bump term right after subscribe, then
-- spit brain happens, as replica doesn't have the actual raft
