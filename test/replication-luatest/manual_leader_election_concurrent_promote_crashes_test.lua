...
g.before_test('test_concurrent_promote_after_bootstrap', function(cg)
...
-- Check that concurrent invocations of `box.ctl.promote` after bootstrap are
-- handled correctly (gh-11708).
g.test_concurrent_promote_after_bootstrap = function(cg)
...
g.before_test('test_concurrent_promote_during_bootstrap', function(cg)
...
-- Check that concurrent invocation of `box.ctl.promote` during bootstrap is
-- handled correctly (gh-11703).
g.test_concurrent_promote_during_bootstrap = function(cg)
    cg.server1:exec(function()
