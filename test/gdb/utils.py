...
class GdbSession(object):
    ...
    def __run_test(self, ut_file, gdb_cmds):
        ...
        cmd.extend([
            ...
            # This python code is used to launch unit tests from the just "sourced" ut_file and
            # transfer the result to the caller (returncode is 0 only if the tests have succeed)
