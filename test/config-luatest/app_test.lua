...
-- Verify that a script without 'early_load' tag is executed after box.cfg.
--
-- This is the default behavior.
g.test_app_without_early_load_tag = function(g)
    local script = [[
...
-- Verify that a script with 'early_load' tag is executed before box.cfg.
--
-- This is supported after gh-10182.
g.test_app_with_early_load_tag = function(g)
    local script = [[
        -- early_load: true
