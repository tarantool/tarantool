...
local f = {
    {'a', type = 'number'},
    {'b', type = 'num', is_nullable = true},
    {'c', type = 'array'},
    {'d', type = 'array'},
}
box.schema.space.create('fc', {field_count = 4})
box.schema.space.create('user', {user = 'guest'})
box.schema.space.create('format', {format = f})
box.schema.space.create('fc_user', {field_count = 4, user = 'guest'})
box.schema.space.create('fc_format', {field_count = 4, format = f})
box.schema.space.create('user_format', {user = 'guest', format = f})
box.schema.space.create('all', {field_count = 4, user = 'guest', format = f})
