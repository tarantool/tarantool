...
g.test_downgrade_sanity_checks = function(cg)
    cg.server:exec(function()
        ...
        local err_msg = "error during parsing version string"
        t.assert_error_msg_contains(err_msg, box.schema.downgrade, 'xxx')
        t.assert_equals(schema_version(), version)
        t.assert_error_msg_contains(err_msg, box.schema.downgrade, '2')
        t.assert_equals(schema_version(), version)
        t.assert_error_msg_contains(err_msg, box.schema.downgrade, '2.2')
        t.assert_equals(schema_version(), version)
        t.assert_error_msg_contains(err_msg, box.schema.downgrade, '2.2.2.2')
        t.assert_equals(schema_version(), version)
