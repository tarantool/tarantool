...
local function test_hash_with_num(cg, start_num)
    cg.server:exec(function(start_num)
        ...
        -- This key part disables fast hashing optimizations. They are only
        -- available for several fields of trivial types with no special
        -- attributes like being nullable or having a collation.
