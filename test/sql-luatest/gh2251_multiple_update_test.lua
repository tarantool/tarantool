...
local g = t.group("test", {{engine = 'memtx'}, {engine = 'vinyl'}})
...
--
g.test_gh_2251_multiple_update = function(cg)
    cg.server:exec(function()
        ...
        res = box.execute("UPDATE t2 SET e=e+1 WHERE b IN (SELECT b FROM t2);")
        t.assert_equals(res, {row_count = 2})
