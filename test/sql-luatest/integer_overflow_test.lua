...
--
-- Make sure CAST can also cause overflow.
--
...
--
-- gh-3810: make sure that if the space contains integers
-- in the range [INT64_MAX, UINT64_MAX], they are handled
-- appropriately in SQL.
--
