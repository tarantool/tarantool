...
g.test_boolean = function(cg)
    cg.server:exec(function()
        ...
        local func_body = "function(x) return type(x) == 'boolean' end"
        ...
        local res = box.execute([[SELECT a FROM t WHERE a;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT a FROM t WHERE a != true;]])
        ...
        box.execute(sql)
        box.execute([[INSERT INTO t0def(i) VALUES (1);]])
        res = box.execute([[SELECT * FROM t0def;]])
        t.assert_equals(res.rows, {{1, true}})

        box.execute([[DROP TABLE t0def;]])

        -- Check UNKNOWN value for boolean.
        box.execute([[CREATE TABLE t0 (i INT PRIMARY KEY, a BOOLEAN);]])
        box.execute([[INSERT INTO t0 VALUES (1, false);]])
        box.execute([[INSERT INTO t0 VALUES (2, true);]])
        box.execute([[INSERT INTO t0 VALUES (3, NULL);]])
        box.execute([[INSERT INTO t0 VALUES (4, UNKNOWN);]])
        ...
        res = box.execute([[SELECT * FROM t0;]])
        ...
        sql = [[CREATE TABLE ts (id INT PRIMARY KEY AUTOINCREMENT,
                s SCALAR);]]
        box.execute(sql)
        box.execute([[INSERT INTO ts SELECT * FROM t0;]])

        res = box.execute([[SELECT s FROM ts WHERE s = true;]])
        t.assert_equals(res.rows, {{true}})

        box.execute([[INSERT INTO ts(s) VALUES ('abc'), (12.5);]])
        ...
        res = box.execute([[SELECT s FROM ts WHERE s IN (true, 1, 'abcd');]])
        t.assert_equals(res.rows, {{true}})
        ...
        box.execute([[CREATE INDEX i0 ON t0(a);]])
        ...
        local result = box.execute('EXPLAIN SELECT * FROM (VALUES(true)), t;')
        local i = 0
        ...
        res = box.execute([[SELECT return_type(a) FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT return_type('false');]])
        t.assert_equals(res.rows, {{'string'}})

        res = box.execute([[SELECT is_boolean(a) FROM t LIMIT 1;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT is_boolean('true');]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT QUOTE(a) FROM t0;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT MIN(a) FROM t0;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT MAX(a) FROM t0;]])
        t.assert_equals(res.rows, {{true}})
        ...
        res = box.execute([[SELECT COUNT(a) FROM t0;]])
        ...
        res = box.execute(sql, {true, false})
        t.assert_equals(res.rows, exp)
        ...
        exp = {{false, true}}
        res = box.execute('SELECT :value1, @value2;', parameters)
        t.assert_equals(res.rows, exp)
        ...
        box.execute([[CREATE TABLE t2 (a BOOLEAN PRIMARY KEY,
        ...
        box.execute([[INSERT INTO t2 VALUES (true, NULL)]])
        box.execute([[INSERT INTO t2 VALUES (false, true)]])

        -- Check interactions with UNIQUE constraint.
        box.execute([[CREATE TABLE t3 (i INT PRIMARY KEY, a BOOLEAN,
        ...
        res = box.execute([[SELECT cast('true' AS BOOLEAN),
        ...
        box.execute([[CREATE TABLE t5 (i INT PRIMARY KEY AUTOINCREMENT,
                      b BOOLEAN);]])
        box.execute([[CREATE TRIGGER r AFTER INSERT ON t4 FOR EACH ROW BEGIN
        ...
        res = box.execute([[SELECT * FROM t5;]])
        t.assert_equals(res.rows, {{1, true}})
        ...
        res = box.execute([[SELECT * FROM t4 UNION SELECT * FROM t5;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT * FROM t4 UNION ALL SELECT * FROM t5;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT * FROM t4 INTERSECT SELECT * FROM t5;]])
        t.assert_equals(res.rows, {{100, false}})
        ...
        --    {100, 100, false, false},
        --}
        --res, err = box.execute([[SELECT * FROM
        ...
        res = box.execute([[SELECT DISTINCT * FROM v;]])
        t.assert_equals(res.rows, exp)

        -- Check CTE.
        box.execute([[WITH temp(x, y) AS (VALUES (111, false)
        ...
        res = box.execute([[WITH RECURSIVE cnt(x, y) AS (VALUES(1, false)
        ...
        res = box.execute([[SELECT * FROM t4 JOIN t5 ON t4.a = t5.b;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT * FROM t4 LEFT JOIN t5 ON t4.a = t5.b;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT * FROM t4 INNER JOIN t5 ON t4.a = t5.b;]])
        t.assert_equals(res.rows, exp)

        -- Check UPDATE.
        box.execute([[UPDATE t4 SET a = NOT a;]])
        ...
        res = box.execute([[SELECT i, CASE WHEN a == true AND
                            i % 2 == 1 THEN false
        ...
        res = box.execute([[SELECT a, COUNT(*) FROM (SELECT * FROM t4
                            UNION SELECT * FROM t5) GROUP BY a;]])
        t.assert_equals(res.rows, exp)

        -- Check logical, bitwise and arithmetical operations.
        box.execute([[CREATE TABLE t6 (a1 BOOLEAN PRIMARY KEY, a2 BOOLEAN);]])
        box.execute([[INSERT INTO t6 VALUES (true, false), (false, true);]])

        res = box.execute([[SELECT NOT true;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT NOT false;]])
        t.assert_equals(res.rows, {{true}})
        ...
        res = box.execute([[SELECT a, NOT a FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT true AND true;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true AND false;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false AND true;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false AND false;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT true OR true;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true OR false;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false OR true;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false OR false;]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT a, true AND a FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, false AND a FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, true OR a FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, false OR a FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, a AND true FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a AND false FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a OR true FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a OR false FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a1, a AND a1 FROM t, t6;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a1, a OR a1 FROM t, t6;]])
        t.assert_equals(res.rows, exp)
        ...
        -- Check comparisons.
        res = box.execute([[SELECT true > true;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT true > false;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false > true;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false > false;]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT a, true > a FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, false > a FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, true < a FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, a > true FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, a < false FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a1, a > a1 FROM t, t6;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT true IN (true);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false IN (true);]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT true IN (false);]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false IN (false);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true IN (true, false);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false IN (true, false);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true IN (SELECT a1 FROM t6);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false IN (SELECT a1 FROM t6);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true IN (SELECT a1 FROM t6 LIMIT 1);]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false IN (SELECT a1 FROM t6 LIMIT 1);]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true IN (1, 1.2, 'true', false);]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false IN (1, 1.2, 'true', false);]])
        t.assert_equals(res.rows, {{true}})
        ...
        res = box.execute([[SELECT a, a IN (true) FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a IN (false) FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, a IN (SELECT a1 FROM
                            t6 LIMIT 1) FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, a IN (1, 1.2, 'true', false) FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a IN (true, false) FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT a, a IN (SELECT a1 FROM t6) FROM t;]])
        t.assert_equals(res.rows, exp)

        res = box.execute([[SELECT true BETWEEN true AND true;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false BETWEEN true AND true;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT true BETWEEN false AND false;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false BETWEEN false AND false;]])
        t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT true BETWEEN true AND false;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false BETWEEN true AND false;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT true BETWEEN false AND true;]])
         t.assert_equals(res.rows, {{true}})

        res = box.execute([[SELECT false BETWEEN false AND true;]])
         t.assert_equals(res.rows, {{true}})
        ...
        res = box.execute([[SELECT a, a BETWEEN true AND true FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a BETWEEN false AND false FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a BETWEEN true AND false FROM t;]])
        t.assert_equals(res.rows, exp)
        ...
        res = box.execute([[SELECT a, a BETWEEN false AND true FROM t;]])
        t.assert_equals(res.rows, exp)

        -- Check interaction of BOOLEAN and INTEGER.
        box.execute([[CREATE TABLE t7 (b INT PRIMARY KEY);]])
        box.execute([[INSERT INTO t7 VALUES (123);]])
        ...
        res = box.execute([[SELECT false AND 2;]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT 2 AND false;]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT b, false AND b FROM t7;]])
        t.assert_equals(res.rows, {{123, false}})

        res = box.execute([[SELECT b, b AND false FROM t7;]])
        t.assert_equals(res.rows, {{123, false}})
        ...
        res = box.execute([[SELECT true IN (0, 1, 2, 3);]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false IN (0, 1, 2, 3);]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT a1, a1 IN (0, 1, 2, 3) FROM t6;]])
        t.assert_equals(res.rows, exp)
        ...
        box.execute([[CREATE TABLE t8 (c DOUBLE PRIMARY KEY);]])
        box.execute([[INSERT INTO t8 VALUES (4.56);]])

        exp_err = 'Type mismatch: can not convert decimal(2.3) to boolean'
        _, err = box.execute([[SELECT true AND 2.3;]])
        t.assert_equals(tostring(err), exp_err)

        res = box.execute([[SELECT false AND 2.3;]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT 2.3 AND false;]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT c, false AND c FROM t8;]])
        ...
        res = box.execute([[SELECT c, c AND false FROM t8;]])
        t.assert_equals(res.rows, {{4.56, false}})
        ...
        res = box.execute([[SELECT true IN (0.1, 1.2, 2.3, 3.4);]])
        t.assert_equals(res.rows, {{false}})

        res = box.execute([[SELECT false IN (0.1, 1.2, 2.3, 3.4);]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT a2 IN (0.1, 1.2, 2.3, 3.4)
                            FROM t6 LIMIT 1;]])
        t.assert_equals(res.rows, {{false}})
        ...
        _, err = box.execute([[SELECT a2 IN (SELECT c FROM t8) FROM t6 LIMIT 1;]])
        t.assert_equals(tostring(err), exp_err)
        ...
        _, err = box.execute([[SELECT a1 IN (SELECT c FROM t8) FROM t6 LIMIT 1;]])
        t.assert_equals(tostring(err), exp_err)
        ...
        box.execute([[CREATE TABLE t9 (d TEXT PRIMARY KEY);]])
        box.execute([[INSERT INTO t9 VALUES ('AsdF');]])

        exp_err = "Type mismatch: can not convert string('abc') to boolean"
        _, err = box.execute([[SELECT true AND 'abc';]])
        t.assert_equals(tostring(err), exp_err)

        res = box.execute([[SELECT false AND 'abc';]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT 'abc' AND false;]])
        t.assert_equals(res.rows, {{false}})
        ...
        res = box.execute([[SELECT d, false AND d FROM t9;]])
        ...
        res = box.execute([[SELECT d, d AND false FROM t9;]])
        t.assert_equals(res.rows, {{'AsdF', false}})
        ...
        -- 'false'.
        --
        box.execute([[INSERT INTO t9 VALUES
        ...
        res = box.execute([[SELECT d, false AND d FROM t9 WHERE d = 'TRUE';]])
        t.assert_equals(res.rows, {{'TRUE', false}})
        ...
        res = box.execute([[SELECT d, d AND false FROM t9 WHERE d = 'TRUE';]])
        t.assert_equals(res.rows, {{'TRUE', false}})
        ...
        res = box.execute([[SELECT d, false AND d FROM t9 WHERE d = 'FALSE';]])
...
g.test_4462_length_not_take_boolean_arguments = function(cg)
    cg.server:exec(function()
        local exp_err = 'Failed to execute SQL statement: '..
                        'wrong arguments for function LENGTH()'
        local _, err = box.execute([[SELECT LENGTH(a) FROM t0;]])
        t.assert_equals(tostring(err), exp_err)
        ...
        local res = box.execute([[SELECT TYPEOF(a) FROM t0;]])
        t.assert_equals(res.rows, exp)
    end)
end

-- gh-4462: ensure that text representation is uppercase.
g.test_4462_ensure_text_representation_is_uppercase = function(cg)
    cg.server:exec(function()
        local sql = [[SELECT cast(true AS TEXT), cast(false AS TEXT);]]
        ...
        box.execute([[DROP TABLE t8;]])
        box.execute([[DROP TABLE t7;]])
        ...
        box.execute([[DELETE FROM "_func" WHERE "name" = 'check_t1_ck';]])
        box.execute([[DELETE FROM "_func" WHERE "name" = 'return_type';]])
        box.execute([[DELETE FROM "_func" WHERE "name" = 'is_boolean';]])
    end)
end
