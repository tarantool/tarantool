...
local INVALID_NEW_AND_SET_TIME_UNITS = {
    ...
    -- Type tests.
    {
        ...
        err_fn_args_new = {'table', 'datetime.new()'},
        err_fn_args_set = {'table', 'datetime.set()'},
    },
    {
        set = 20010101,
        err_fn = 'expected_type',
...
local function test_invalid_new_and_set_time_units(cg, new_test)
    ...
    local function single_test(set)
        ...
        elseif p.err_fn ~= nil then
            ...
            -- Override of err_fn_args.
            if new_test and p.err_fn_args_new then
                err_fn_args = p.err_fn_args_new
            elseif not new_test and p.err_fn_args_set then
                err_fn_args = p.err_fn_args_set
            end
