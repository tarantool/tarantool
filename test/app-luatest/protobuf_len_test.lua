...
g.test_empty_string = function()
    local protocol = protobuf.protocol({
        protobuf.message('test', {val = {'string', 1}})
    })
    local result = protobuf.encode(protocol, 'test', {val = ''})
    t.assert_equals(string.hex(result), '0a00')
end
...
g.test_ordinary_string = function()
    ...
    local result = protobuf.encode(protocol, 'test', {val = 'protobuf'})
...
g.test_very_long_string = function()
    ...
    local result = protobuf.encode(protocol, 'test', {val = ('a'):rep(2^15)})
