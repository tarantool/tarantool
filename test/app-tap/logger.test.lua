...
line = file:read()
-- Current log entry buffer size is 16KiB (16384 bytes). 1 byte for '\0',
-- making the maximum log entry length 16383 bytes.
test:ok(line:len() == 16383, "big line truncated")
message = json.decode(line)
