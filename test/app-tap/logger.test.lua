...
line = file:read()
-- Current log entry buffer size is 16KiB (16384 bytes), 1 byte is for '\n',
-- 1 byte is for '\0'. Making the maximum log entry length 16382 bytes.
test:ok(line:len() == 16382, "big line truncated")
message = json.decode(line)
