...
box.internal.sql_create_function('RETURN_TYPE', 'TEXT',
		       function(x) return type(x) end);
box.internal.sql_create_function('IS_BOOLEAN', 'BOOLEAN',
		       function(x) return type(x) == 'boolean' end);
test_run:cmd("setopt delimiter ''");
\set language sql
