...
CREATE TABLE DATE_TBL (f1 date primary key);
...
-- FIXME: SET datestyle TO iso;  -- display results in ISO

-- FIXME: SET datestyle TO ymd;
...
SELECT EXTRACT(CENTURY FROM DATE '-0101-12-31'); -- -2
SELECT EXTRACT(CENTURY FROM DATE '-0100-12-31'); -- -1
SELECT EXTRACT(CENTURY FROM DATE '-0001-12-31'); -- -1
...
SELECT EXTRACT(CENTURY FROM CURRENT_DATE())>=21;     -- true
--
-- millennium
--
--SELECT EXTRACT(MILLENNIUM FROM DATE '0001-12-31 BC'); -- -1
SELECT EXTRACT(MILLENNIUM FROM DATE '-0001-12-31'); -- -1
--SELECT EXTRACT(MILLENNIUM FROM DATE '0001-01-01 AD'); --  1
SELECT EXTRACT(MILLENNIUM FROM DATE '0001-01-01'); --  1
...
SELECT EXTRACT(DECADE FROM DATE '-0001-01-01'); --   0
SELECT EXTRACT(DECADE FROM DATE '-0002-12-31'); --  -1
SELECT EXTRACT(DECADE FROM DATE '-0011-01-01'); --  -1
SELECT EXTRACT(DECADE FROM DATE '-0012-12-31'); --  -2
--
-- all possible fields
--
...
--SELECT DATE_TRUNC('CENTURY', DATE '-0055-08-10'); -- 0100-01-01 BC
--SELECT DATE_TRUNC('DECADE', DATE '1993-12-25'); -- 1990-01-01
--SELECT DATE_TRUNC('DECADE', DATE '0004-12-25'); -- 0001-01-01 BC
----SELECT DATE_TRUNC('DECADE', DATE '0002-12-31 BC'); -- 0011-01-01 BC
--SELECT DATE_TRUNC('DECADE', DATE '-0002-12-31'); -- 0011-01-01 BC
--
-- test infinity
--
-- FIXME: select 'infinity'::date, '-infinity'::date;
-- FIXME: select 'infinity'::date > 'today'::date as t;
-- FIXME: select '-infinity'::date < 'today'::date as t;
-- FIXME: select isfinite('infinity'::date), isfinite('-infinity'::date), isfinite('today'::date);
--
