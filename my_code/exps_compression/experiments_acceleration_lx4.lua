...
for accel = MIN_ACCEL, MAX_ACCEL do
    ...
    run(snap_cmd)
    local reco_cnd_2 = string.format('du -ha /home/sandrech/tarantool/build/box_snapshot,engine=memtx,index=TREE,nohint=false,sk_count=1,row_count=100000000,column_count=3')
