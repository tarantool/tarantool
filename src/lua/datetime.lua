...
local MAX_DATE_TEXT = ('%d-%02d-%02d'):format(MAX_DATE_YEAR, MAX_DATE_MONTH,
                                              MAX_DATE_DAY)
local MIN_DT_DAY = INT_MIN
local MAX_DT_DAY = INT_MAX
local MIN_EPOCH_SECS_VALUE = MIN_DT_DAY * SECS_PER_DAY - SECS_EPOCH_OFFSET
local MAX_EPOCH_SECS_VALUE = MAX_DT_DAY * SECS_PER_DAY - SECS_EPOCH_OFFSET
