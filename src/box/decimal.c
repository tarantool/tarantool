...
/* {{{ decimal dynamic allocation (helpers) */

size_t
box_decimal_storage_size(void)
{
	return sizeof(decimal_t);
}

size_t
box_decimal_storage_align(void)
{
	return alignof(decimal_t);
}

size_t
box_decimal_string_buffer_size(void)
{
	return DECIMAL_MAX_STR_LEN;
}
