...
const char *sqlite3OpcodeName(int i){
 static const char *const azName[] = {
    ...
    /*  95 */ "SetCookie"        OpHelp(""),
    /*  96 */ "ReopenIdx"        OpHelp("root=P2"),
    /*  97 */ "OpenRead"         OpHelp("root=P2"),
    /*  98 */ "OpenWrite"        OpHelp("root=P2"),
    ...
    /* 106 */ "NextId"           OpHelp("r[P3]=get_max(space_index[P1]{Column[P2]})"),
