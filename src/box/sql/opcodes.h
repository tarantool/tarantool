...
#define OP_If             38
#define OP_IfNot          39
#define OP_SeekLT         40 /* synopsis: key=r[P3@P4]                     */
#define OP_SeekLE         41 /* synopsis: key=r[P3@P4]                     */
#define OP_SeekGE         42 /* synopsis: key=r[P3@P4]                     */
#define OP_SeekGT         43 /* synopsis: key=r[P3@P4]                     */
#define OP_NoConflict     44 /* synopsis: key=r[P3@P4]                     */
#define OP_NotFound       45 /* synopsis: key=r[P3@P4]                     */
#define OP_Found          46 /* synopsis: key=r[P3@P4]                     */
#define OP_Last           47
#define OP_SorterSort     48
#define OP_Sort           49
#define OP_Rewind         50
#define OP_IdxLE          51 /* synopsis: key=r[P3@P4]                     */
#define OP_IdxGT          52 /* synopsis: key=r[P3@P4]                     */
#define OP_IdxLT          53 /* synopsis: key=r[P3@P4]                     */
#define OP_IdxGE          54 /* synopsis: key=r[P3@P4]                     */
