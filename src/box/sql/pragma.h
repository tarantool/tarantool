...
static const char *const pragCName[] = {
  /*   0 */ "cid",         /* Used by: table_info */
  /*   1 */ "name",       
  /*   2 */ "type",       
  /*   3 */ "notnull",    
  /*   4 */ "dflt_value", 
  /*   5 */ "pk",         
  /*   6 */ "table",       /* Used by: stats */
  /*   7 */ "index",      
  /*   8 */ "width",      
  /*   9 */ "height",     
  /*  10 */ "seqno",       /* Used by: index_info */
  /*  11 */ "cid",        
  /*  12 */ "name",       
  /*  13 */ "seqno",       /* Used by: index_xinfo */
  /*  14 */ "cid",        
  /*  15 */ "name",       
  /*  16 */ "desc",       
  /*  17 */ "coll",       
  /*  18 */ "key",        
  /*  19 */ "seq",         /* Used by: index_list */
  /*  20 */ "name",       
  /*  21 */ "unique",     
  /*  22 */ "origin",     
  /*  23 */ "partial",    
  /*  24 */ "seq",         /* Used by: database_list */
  /*  25 */ "name",       
  /*  26 */ "file",       
  /*  27 */ "seq",         /* Used by: collation_list */
  /*  28 */ "name",       
  /*  29 */ "id",          /* Used by: foreign_key_list */
  /*  30 */ "seq",        
  /*  31 */ "table",      
  /*  32 */ "from",       
  /*  33 */ "to",         
  ...
  /*  39 */ "parent",     
  /*  40 */ "fkid",       
  /*  41 */ "busy",        /* Used by: wal_checkpoint */
  /*  42 */ "log",        
  /*  43 */ "checkpointed",
  /*  44 */ "timeout",     /* Used by: busy_timeout */
};
