...
struct ast_create_table {
	...
	/** If TRUE: do not raise an error when the table already exists. */
	bool if_not_exists;
};
...
struct ast_create_view {
	...
	struct ast_select *select;
	/** If TRUE: do not raise an error when the view already exists. */
	bool if_not_exists;
};
...
struct ast_create_index {
	...
	struct ast_expr_list *columns;
	/** If TRUE: do not raise an error when the index already exists. */
	bool if_not_exists;
...
struct ast_create_trigger {
	...
	/** Actions list of the trigger. */
	struct ast_trigger_action_list *actions;
	/** If TRUE: do not raise an error when the trigger already exists. */
	bool if_not_exists;
	/** Flag to distinguish between FOR EACH ROW and FOR EACH STATEMENT. */
	bool is_for_each_row;
};
...
struct ast_drop_table {
	/** Table or view name. */
	struct Token name;
	/** If TRUE: do not raise an error when the table or view is missing. */
	bool if_exists;
};
...
struct ast_drop_index {
	...
	/** Table name. */
	struct Token table;
	/** If TRUE: do not raise an error when the index is missing. */
	bool if_exists;
};
...
struct ast_drop_trigger {
	/** Trigger name. */
	struct Token name;
	/** If TRUE: do not raise an error when the trigger is missing. */
	bool if_exists;
};
...
/**
 * Convert `struct ast_trigger` to `struct sql_trigger`.
 *
 * Return NULL on error.
 */
struct sql_trigger *
