...
local roles_state = {
    ...
    -- where key is the tag name and the value is the tag value. See
    -- file.get_file_tags() known_tags list for details.
    tags = {},
