...
local template_cfg = {
    ...
    replication_split_brain_handling_mode = 'string',
...
local dynamic_cfg = {
    ...
    replication_split_brain_handling_mode =
        private.cfg_set_replication_split_brain_handling_mode,
...
local dynamic_cfg_order = {
    ...
    replication_split_brain_handling_mode = 150,
...
local dynamic_cfg_skip_at_load = {
    ...
    replication_split_brain_handling_mode = true,
