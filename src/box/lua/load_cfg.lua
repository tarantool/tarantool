...
local default_cfg = {
    ...
    log_context_generator = log.cfg.context_generator,
    log_fields_order      = log.cfg.fields_order,
...
local template_cfg = {
    ...
    log_modules           = 'table',
    log_format            = 'string',
    log_context_generator = 'string',
    log_fields_order      = 'table',
...
local dynamic_cfg_modules = {
    ...
    log = {
        ...
        options = {
            ...
            log_format = true,
            log_nonblock = true,
            log_context_generator = true,
            log_fields_order = true,
        },
        skip_at_load = true,
    }
}
