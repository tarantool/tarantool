...
#
# https://github.com/google/benchmark/blob/f4f93b5553ced834b2120048f65690cddb4b7a2f/LICENSE
# https://github.com/google/benchmark/issues/1891
        ...
        if "context" in results:
            if "json_schema_version" in results["context"]:
                ...
                if json_schema_version != 1:
                    print(
                        "In %s, got unsupported JSON schema version: %i, expected 1"
