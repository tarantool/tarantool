...
foreach(test ${CAPI_TESTS})
  ...
  set_tests_properties(${test_title} PROPERTIES
    LABELS "fuzzing;luajit-capi"
    DEPENDS lua-tests
  )
endforeach()

# The same tests as in ligurio/lua-c-api-tests with the following
# exceptions:
# - string.buffer Lua module is not available in Tarantool, so
#   string_buffer_encode_test.lua and
#   string_buffer_torture_test.lua are disabled.
