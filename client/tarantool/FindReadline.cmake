...
IF (READLINE_HISTORY_LIBRARY AND READLINE_READLINE_LIBRARY AND READLINE_INCLUDE_DIR)
	...
	IF (CURSES_FOUND)
		SET (READLINE_LIBS ${CURSES_LIBRARIES} ${READLINE_HISTORY_LIBRARY} ${READLINE_READLINE_LIBRARY})
		SET (READLINE_INCLUDE_DIR ${CURSES_INCLUDE_DIR} ${READLINE_INCLUDE_DIR})
	ELSE(CURSES_FOUND)
		IF (TERMCAP_FOUND)
			SET (READLINE_LIBS ${TERMCAP_LIBRARY} ${READLINE_HISTORY_LIBRARY} ${READLINE_READLINE_LIBRARY})
